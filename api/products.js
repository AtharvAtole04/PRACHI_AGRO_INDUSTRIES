...
export default async function handler(req, res) {
  ...
  // Admin operations (POST, PUT, DELETE) are handled by Render backend
  if (req.method !== 'GET') {
    try {
      const renderUrl = `https://prachi-agro-industries.onrender.com${req.url || '/api/products'}`;
  ...
  // Vercel Serverless Function ONLY handles GET requests for products
  try {
    await connectDb();
