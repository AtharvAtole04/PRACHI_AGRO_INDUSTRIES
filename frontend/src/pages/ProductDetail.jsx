...
कृपया किंमत आणि उपलब्धता कळवा.`;
  ...
  return (
    <div className="flex flex-col gap-10 text-left">
      ...
      {/* Main Details Grid */}
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-12 bg-white p-4 sm:p-6 md:p-8 rounded-3xl border border-slate-100 shadow-sm">
      ...
      <div className="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
        ...
        <div className="flex border-b border-slate-100 bg-slate-50/50 overflow-x-auto no-scrollbar">
          <button
            ...
            className={`flex-1 md:flex-none px-3 sm:px-6 py-3 sm:py-4 text-xs sm:text-sm font-bold border-b-2 whitespace-nowrap transition-all cursor-pointer ${
              activeTab === 'details'
          ...
          >
            {language === 'mr' ? 'वापरण्याची पद्धत' : 'How to Use'}
          </button>
          <button
